  ...
  val insertQuestDataNoDevId: fragment.Fragment =
    sql"""
        INSERT INTO quests (
          ...
          ('USER001', 'QUEST016', 'Demonic', 'Implement User Authentication', 'Set up Auth0 integration and secure routes using JWT tokens.', 'Some acceptance criteria', '2025-01-01 00:00:00', '2025-01-02 12:00:00');
      """
}
